 ...
 * Une [documentation d'installation](installation.md) si vous devez juste utiliser les ressources.
 * Une documentation sur le [packaging](package.md) de ce projet.
 * Une documentation des [ressources](api/index.md) fournies par ce projet.
